...
Route::prefix('locataire')->name('locataire.')->middleware(['auth', 'role:locataire,colocataire'])->group(function () {
    ...
    Route::get('/annonces/create/{logement_id}', [LogementlocaController::class, 'create'])->name('annonces.create');
    Route::post('/annonces/store', [LogementlocaController::class, 'storeAnnonce'])->name('annonces.store');
