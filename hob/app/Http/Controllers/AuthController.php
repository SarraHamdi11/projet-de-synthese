...
public function visitor()
{
    ...
    public function signup(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'tel_uti.required' => 'Phone number is required.',
            'tel_uti.max' => 'Phone number must not exceed 15 characters.',
            'email_uti.required' => 'Email address is required.',
            'email_uti.email' => 'Please enter a valid email address.',
            'email_uti.unique' => 'This email is already registered.',
            'nom_uti.required' => 'Last name is required.',
            'prenom.required' => 'First name is required.',
            'ville.required' => 'City is required.',
            'date_naissance.required' => 'Date of birth is required.',
            'role_uti.required' => 'User role is required.',
            'photodeprofil_uti.image' => 'The file must be an image.',
            'photodeprofil_uti.max' => 'The image size must not exceed 2 MB.',
            'mot_de_passe_uti.required' => 'Password is required.',
            'mot_de_passe_uti.min' => 'Password must be at least 8 characters.',
            'mot_de_passe_uti.confirmed' => 'Password confirmation does not match.',
        ]);
